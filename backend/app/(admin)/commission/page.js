    ...
    <div className="max-w-sm">
      ...
      <div className="flex items-center gap-3">
        <input
          ...
          className="w-24 px-3 py-2 rounded-lg bg-livra-surfaceElevated border border-livra-divider"
        />
        <span>%</span>
      </div>
      ...
      <p className="text-livra-textSecondary text-sm mt-3">Ce taux sert de valeur par défaut pour les nouveaux vendeurs ; chaque vendeur peut ensuite être ajusté individuellement dans sa fiche.</p>
    </div>
  );
}
